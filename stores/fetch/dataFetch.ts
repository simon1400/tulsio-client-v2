    ...
    if (link === 'blog' || link === 'tags') {
      ...
      if (categoryDataReq.categories.data.length) {
        ...
        if (tagDataReq.labels.data.length) {
          ...
          description = tagDataReq.labels.data[0]?.attributes?.meta?.description
    ...
    if (link === 'blog' || link === 'tags') {
      ...
      if (categoryDataReq.categories.data.length) {
        ...
        if (tagDataReq.labels.data.length) {
          ...
          dataTitle =
            articleBaseReq.articlesBase.data[0]?.attributes?.meta?.title ||
            articleBaseReq.articlesBase.data[0]?.attributes?.title
